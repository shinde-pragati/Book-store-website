...
if (newsletterForm) {
    newsletterForm.addEventListener('submit', (e) => {
        ...
        successMessage.innerHTML = `
            ...
            <span>Thank you for subscribing! You'll receive our newsletter soon.</span>
        `;
...
// Book "Add to Cart" Button Functionality
const addToCartButtons = document.querySelectorAll('.book-card .btn-small');
